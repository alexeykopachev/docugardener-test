...
def apply_surcharge_3ffe5f(amount: float, surcharge_pct: float, currency: str = "USD") -> dict:
    """Apply a percentage-based surcharge to a payment transaction.
...
def calculate_fx_conversion_fd90bc(
    from_currency: str,
    to_currency: str,
    amount: float,
    rate: float,
...
def apply_surcharge_9719b7(amount: float, surcharge_pct: float, currency: str = "USD") -> dict:
    """Apply a percentage-based surcharge to a payment transaction.
...
"""Refund service module — aaa4fd.

Provides issue_refund_aaa4fd for processing order refunds.
"""
...
def validate_card_payment_3dd8c9(method: str, card_last4: str, amount: float) -> dict:
    """Authorise a card-based payment after validating the payment method.
...
def apply_surcharge_097e1b(amount: float, surcharge_pct: float, currency: str = "USD") -> dict:
    """Apply a percentage-based surcharge to a payment transaction.
...
def calculate_fx_conversion_56e3e0(
    from_currency: str,
    to_currency: str,
    amount: float,
    rate: float,
...
def validate_card_payment_8ca9a2(method: str, card_last4: str, amount: float) -> dict:
    """Authorise a card-based payment after validating the payment method.
...
def apply_surcharge_124b55(amount: float, surcharge_pct: float, currency: str = "USD") -> dict:
    """Apply a percentage-based surcharge to a payment transaction.
...
def calculate_fx_conversion_572f33(
    from_currency: str,
    to_currency: str,
    amount: float,
    rate: float,
...
"""Refund service module — 9ee8b6.

Provides issue_refund_9ee8b6 for processing order refunds.
"""


def issue_refund_9ee8b6(order_id: str, amount: float, reason: str) -> dict:
    """Issue a refund for a completed order.
...
def validate_card_payment_2eb004(method: str, card_last4: str, amount: float) -> dict:
    """Authorise a card-based payment after validating the payment method.
